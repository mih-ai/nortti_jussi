# "Nörtti-Jussi" - OpenAI-rajapinnalla varustettu "pohjakoodi" tekoälyn hyödyntämistä varten
...
Technically, "Nörtti-Jussi" is a python module that you can easily use by looking at the latest OpenAI (ChaptGPT) features. You can get more information about this by taking a closer look at the attached program code. Or - just install and try how it works. 
